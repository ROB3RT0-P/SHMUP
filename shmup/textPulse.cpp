...
PulseText::PulseText(SDL_Renderer* renderer, const std::string& fontPath, int fontSize, SDL_Color textColor, const std::string text)
...
{
    // RJP - TODO: Fix this.
    // RJP - This doesn't fade in and out properly.
...
void PulseText::Render(int x, int y) 
{
